...
public class JavaPredicateEx3 {
    ...
    public static void main(String[] args) {
        ...
        countries.add(new Country("Brasil", 989622000));

//        Predicate<Country> p1 = c -> c.getName().startsWith("I") && c.getPopulation() > 10000000;

        Predicate<Country> p2 = country -> country.getPopulation() > 10000000;

        countries.stream().filter(p2).forEach(System.out::println);
    }
}
